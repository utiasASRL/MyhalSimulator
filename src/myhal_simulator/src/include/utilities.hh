...
namespace utilities{
    ...
    std::vector<ignition::math::Line3d> get_box_edges(ignition::math::AxisAlignedBox box);

    std::vector<ignition::math::Vector3d> get_corners(gazebo::physics::EntityPtr entity);

    std::vector<ignition::math::Vector3d> get_box_corners(ignition::math::AxisAlignedBox box);

    double width(ignition::math::AxisAlignedBox box);

    double height(ignition::math::AxisAlignedBox box);

    bool inside_box(ignition::math::AxisAlignedBox box, ignition::math::Vector3d point, bool edge = false);
    ...
    ignition::math::Vector3d min_box_repulsive_vector(ignition::math::Vector3d pos, ignition::math::AxisAlignedBox box);
    ...
    bool contains(ignition::math::AxisAlignedBox b1, ignition::math::AxisAlignedBox b2); // returns true if b1 contains b2 (in a 2d)


    double dist_to_box(ignition::math::Vector3d pos, ignition::math::AxisAlignedBox box);
